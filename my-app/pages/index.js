      ...
      <div class="flex flex-row">
        <div class="basis-1/2 justify-center items-center align-middle h-72 mt-24 ml-36">
          <div class="flex flex-col ">
            <div class="justify-self-center mt-6 ml-32">
              {" "}
              <img src="sharelock.png" class="h-auto w-32 rounded-lg" alt="" />
            </div>
            <div class="ml-12">
              {" "}
              <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
                <span class="text-transparent bg-clip-text bg-gradient-to-r to-gray-600 from-gray-400">
                  ShareLock
                </span>{" "}
              </h1>
            </div>
            <div class="w-50">
              {" "}
              <p class="italic bold decoration-2 hover:decoration-4">
